...
public class Bird {
	...
	public static void onCreateResources(MainActivity activity){
		...
		mBirdTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(mBirdBitmapTextureAtlas, activity, "human-mine.png", 4, 1);
		try {
		...
		try {
			mJumpSound = SoundFactory.createSoundFromAsset(activity.getSoundManager(), activity, "Jump1.wav");
			mJumpSound.setVolume(0.5f);
